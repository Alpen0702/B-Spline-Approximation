...
<div align="center">
<img src="https://github.com/Alpen0702/B-Spline-Approximation/blob/master/resources/pre_geo.png" height="300px" alt="geo"><img src="https://github.com/Alpen0702/B-Spline-Approximation/blob/master/resources/pre_al.png" height="300px" alt="al"><br>
左图为几何距离模式，右图为代数距离模式。
</div>
<br><br>
如上图所示，其中左图为几何距离模式，右图为代数距离模式。注意到，其实两张图中给定数据点（蓝色方形）相对位置是基本一致的，只是为了显示控制顶点而缩小了左图而已。但两条曲线的形状截然不同。几何距离模式下的拟合效果要好得多，但也使得这条曲线过分地扭曲，以至于把控制顶点挤压到很远的位置。<br><br>
...
<div align="center">
<img src="https://github.com/Alpen0702/B-Spline-Approximation/blob/master/resources/geo.gif" height="300px" alt="geo" ><img src="https://github.com/Alpen0702/B-Spline-Approximation/blob/master/resources/al.gif" height="300px" alt="al"><br>
左图为几何距离模式，右图为代数距离模式。裁剪gif可能有扭曲，实际上左图中的橙线都是垂直于曲线的。
</div>
<br><br>
